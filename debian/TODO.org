...
** TODO calls savepath?
* Installation
** TODO "Proper" "contrib" Matlab package
** TODO ptb3-matlab (and others) manpage
** TODO .desktop file
** TODO "Fancy" custom initial banner with NeuroDebian
* libwaffle
** for some reason git archive even fails to include it if there is other stuff as well... bizzare -- no time ATM
